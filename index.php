...
?>
    <div class="hai">
        <div class="navbar">
            <div class="icon">
                <h2 class="logo">Shreyansh Tours & Travel</h2>
            </div>
            <div class="menu">
                <ul>
                    <li><a href="#">HOME</a></li>
        ...
        <div class="content">
            <h1>Rent Your <br><span> Car</span></h1>
            <p class="par">
                Just rent a car of your wish from our collection.<br>Enjoy every moment with your family<br>
